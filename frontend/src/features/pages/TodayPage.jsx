...
export default function TodayPage({ dayData, safeRows, phaseFilter, onChangePhaseFilter, selectedFixtureId, onOpenMatch }) {
  return (
    <section className="panel">
      ...
      <MatchTable rows={safeRows} selectedFixtureId={selectedFixtureId} onOpenMatch={onOpenMatch} />
    </section>
  );
}
