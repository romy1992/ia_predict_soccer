...
class TestDownloadMatch(unittest.TestCase):
    ...
    def __init__(self, methodName="runTest"):
        ...
        self.dict_match = {'id_match_fk': "fd7529f4-d623-4c33-b779-8bb8ea0bd45e", 'id_fixture': 1326590,
                           'name_home': 'Inter',
        ...
        self.dict_odds = [{'id_odds_fk': "0000cb55-39f9-43d4-b613-b61cd7cad14f",
        ...
        match = Match(**self.dict_match)
        stat_ = Statistics(**self.dict_stat[0])
        stat__ = Statistics(**self.dict_stat[1])
        odds = Odds(**self.dict_odds[0])
